...
public class ElectronicsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productRef = FirebaseDatabase.getInstance().getReference().child("Electronics");
        recyclerView = findViewById(R.id.electronics_recyclerview);
        recyclerView.setHasFixedSize(true);
        layoutManager = new GridLayoutManager(ElectronicsActivity.this, 2);
        recyclerView.setLayoutManager(layoutManager);

        toolbar = findViewById(R.id.electronics_toolbar);
            ...
            new FirebaseRecyclerAdapter<Products, ProductViewHolder>(options){
                ...
                protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model){
                    ...
                    holder.itemView.setOnClickListener(new View.OnClickListener() {
                        ...
                        Intent intent = new Intent(ElectronicsActivity.this, ProductDetailActivity.class);
