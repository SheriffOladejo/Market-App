...
public class MobilePhonesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.phones_recyclerview);
        recyclerView.setHasFixedSize(true);
        layoutManager = new GridLayoutManager(MobilePhonesActivity.this, 2);
        recyclerView.setLayoutManager(layoutManager);

        toolbar = findViewById(R.id.phones_toolbar);
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model){
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                Intent intent = new Intent(MobilePhonesActivity.this, ProductDetailActivity.class);
